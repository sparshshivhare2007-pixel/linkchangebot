...
OWNER_LINK = os.getenv("OWNER_LINK", "https://t.me/oye_se")
CHANNEL_LINK = os.getenv("CHANNEL_LINK", "https://t.me/linkchangerbotupdate")
SUPPORT_LINK = os.getenv("SUPPORT_LINK", "https://t.me/linkchangerbotsupport")
